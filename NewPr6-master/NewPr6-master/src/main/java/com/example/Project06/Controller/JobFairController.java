...
import com.example.Project06.Dto.JobfairQue.JobFairIdDto;
import com.example.Project06.Dto.ResponceDto;
import com.example.Project06.Dto.Response1Dto;
...
public class JobFairController {
    ...
    public ResponseEntity<?> getJobFairDetailsByJobId(@RequestParam Integer jobId){
        try {
            Response1Dto responseDto = new Response1Dto("success");
